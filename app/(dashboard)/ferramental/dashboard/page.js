  ...
  return (
    <div style={{ padding: '2rem', width: '100%', minHeight: '100vh', background: 'var(--color-bg-tertiary)', fontFamily: "'Inter', system-ui, sans-serif" }}>
      ...
      <div style={{ marginBottom: '2rem' }}>
        <h1 style={{ fontSize: '1.5rem', fontWeight: '900', color: 'var(--color-text-primary)', letterSpacing: '-0.02em' }}>
      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1.75rem' }}>
            ...
            <div style={{ background: 'var(--color-bg-primary)', border: '1px solid var(--color-border-light)', borderRadius: '10px', padding: '1.25rem' }}>
            ...
            <div style={{ background: 'var(--color-bg-primary)', border: '1px solid var(--color-border-light)', borderRadius: '10px', padding: '1.25rem' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem', marginBottom: '1rem' }}>
                <div style={{ background: 'var(--color-bg-tertiary)', borderRadius: '8px', padding: '0.85rem', textAlign: 'center' }}>
          ...
          <div style={{ background: 'var(--color-bg-primary)', border: '1px solid var(--color-border-light)', borderRadius: '10px', overflow: 'hidden' }}>
            ...
            {recentes.length === 0 ? (
              ...
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.8rem' }}>
                  ...
                  <tbody>
                    {recentes.map((r, i) => (
                      <tr key={r.id} style={{ borderBottom: '1px solid var(--color-bg-tertiary)', background: i % 2 === 0 ? 'var(--color-bg-primary)' : 'var(--color-bg-tertiary)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '0.75rem', marginTop: '1.5rem' }}>
            {[
              ...
              <Link key={link.href} href={link.href} style={{ background: 'var(--color-bg-primary)', border: '1px solid var(--color-border-light)', borderRadius: '8px', padding: '1rem', textDecoration: 'none', display: 'block', transition: 'border-color 0.15s' }}>
